...
- **Narrative character**  
  A bunny introduces and guides the player early on, then reappears during the retrospective, giving the game a consistent voice beyond its mechanics.
- **Accessibility options**  
  Adjustable camera sensitivity and sound volume.
